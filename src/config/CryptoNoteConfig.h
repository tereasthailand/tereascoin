...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xc2d8c699c;
...
const uint64_t LWMA_3_DIFFICULTY_BLOCK_INDEX                 = 99999999;
...
*/
const char GENESIS_COINBASE_TX_HEX[] = "010a01ff000180e0bcefa757029aa4abdd7af042e3aa7ccc14233a569357eb0004b531a3b43bf6b2ae6f11dde0210179357f0427afbbdcd6482fcab17c9a959dbba52cbb909d439e9e6229ed1f27a0";
...
const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1547359181;

const size_t   CRYPTONOTE_REWARD_BLOCKS_WINDOW               = 100;
const size_t   CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE     = 307200; //size of block (bytes) after which reward for block calculated using block size
const size_t   CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE_V2  = 307200;
const size_t   CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE_V1  = 307200;
...
const uint32_t MIXIN_LIMITS_V3_HEIGHT                        = 2000000;

/* The mixin to use by default with zedwallet and turtle-service */
/* DEFAULT_MIXIN_V0 is the mixin used before MIXIN_LIMITS_V1_HEIGHT is started */
const uint64_t DEFAULT_MIXIN_V0                              = 7;
...
const size_t   MAX_BLOCK_SIZE_INITIAL                        = 300 * 1024;
const uint64_t MAX_BLOCK_SIZE_GROWTH_SPEED_NUMERATOR         = 300 * 1024;
const uint64_t MAX_BLOCK_SIZE_GROWTH_SPEED_DENOMINATOR       = 365 * 24 * 60 * 60 / DIFFICULTY_TARGET;
const uint64_t MAX_EXTRA_SIZE                                = 300 * 1024;
...
const uint32_t UPGRADE_HEIGHT_V4                             = 35000000; // Upgrade height for CN-Lite Variant 1 switch.
const uint32_t UPGRADE_HEIGHT_V5 			     = 70000000; // Upgrade height for CN-Turtle Variant 2 switch.
...
const char     CRYPTONOTE_NAME[]                             = "TereasCoin";
...
const char     LATEST_VERSION_URL[]                          = "http://tereas.co.in";
const std::string LICENSE_URL                                = "https://github.com/tereasthailand/tereascoin/blob/master/LICENSE";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
   {  0x74, 0x65, 0x72, 0x65, 0x61, 0x73, 0x63, 0x6f, 0x69, 0x6e, 0x66, 0x61, 0x72, 0x6d, 0x65, 0x72  } 
};

const char* const SEED_NODES[] = {
"74.208.223.179:11897",
"74.208.103.37:11897",
"74.208.103.40:11897"
};
} // CryptoNote
